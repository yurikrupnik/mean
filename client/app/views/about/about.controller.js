...
function AboutController() {
    ...
    vm.remove = function (item) {
        console.log('item reniv', item);
    };

    vm.bool = false;

    vm.selectedPeople = [vm.people[2]];
    //
    // vm.selectedColors = [];
    // vm.selectedItem = vm.itemArray[2];
    //
    // vm.handleChange = function (item, modal) {
    //     console.log('item', item);
    ...
    // ];
    //
    // $scope.selectedPeople = [vm.people[1], vm.people[3]];
    //
