// Generated on 2016-04-28 using generator-angular-fullstack 3.6.1
'use strict';
...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    watch: {
      babel: {
        files: ['<%= yeoman.client %>/{app,components, filters}/**/!(*.spec|*.mock).js'],
      ...
      injectJS: {
        files: [
          '<%= yeoman.client %>/{app,components, filters}/**/!(*.spec|*.mock).js',
          '!<%= yeoman.client %>/app/app.js'
        ],
        tasks: ['injector:scripts']
      },
      injectCss: {
        files: ['<%= yeoman.client %>/{app,components, filters}/**/*.css'],
        tasks: ['injector:css']
      },
      mochaTest: {
      ...
      injectLess: {
        files: ['<%= yeoman.client %>/{app,components, filters}/**/*.less'],
        tasks: ['injector:less']
      },
      less: {
        files: ['<%= yeoman.client %>/{app,components, filters}/**/*.less'],
      ...
      livereload: {
        files: [
          '{.tmp,<%= yeoman.client %>}/{app,components, filters}/**/*.{css,html}',
          '{.tmp,<%= yeoman.client %>}/{app,components, filters}/**/!(*.spec|*.mock).js',
    ...
    jshint: {
      ...
      all: ['<%= yeoman.client %>/{app,components, filters}/**/!(*.spec|*.mock|app.constant).js'],
      test: {
        src: ['<%= yeoman.client %>/{app,components, filters}/**/*.{spec,mock}.js']
      }
    },
    ...
    ngtemplates: {
      ...
      main: {
        cwd: '<%= yeoman.client %>',
        src: ['{app,components,filters}/**/*.html'],
